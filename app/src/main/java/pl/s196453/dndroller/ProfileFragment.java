...
*/
    ...
    private void populateSpinner(View view, Spinner spinner, int id){
    ...
    public void test(){
        ...
        s = Integer.parseInt(strT.getText().toString());
        Log.d("test runs", "works?  "+s);
        d = Integer.parseInt(dexT.getText().toString());
        c = Integer.parseInt(conT.getText().toString());
        i = Integer.parseInt(intT.getText().toString());
        w = Integer.parseInt(wisT.getText().toString());
        ch = Integer.parseInt(chaT.getText().toString());
